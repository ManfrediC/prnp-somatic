...
output="/add/results/2025-03-22_MF_dilution_summary/MF_dilution_summary_original.tsv"
...
# Loop through each sample directory in the new input directory
for dir in /add/results/2025-02-10_MF_loop_original_dilutions/*; do
    sample=$(basename "$dir")
    ...
    if [[ -f "$file" ]]; then
        while read -r line; do
            # Parse fields from the candidate file:
