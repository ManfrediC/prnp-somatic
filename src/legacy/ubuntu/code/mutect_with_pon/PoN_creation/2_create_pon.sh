...
mergedVCF="/add/results/PoN/panel_of_normals/controls_multisample.vcf.gz"  # input (from bcftools)
ponVCF="/add/results/PoN/panel_of_normals/CJD_controls_PoN.vcf.gz"         # output PoN

# -------------------- Build PoN ----------------------------
echo "Running CreateSomaticPanelOfNormals …"
