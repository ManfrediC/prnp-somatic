...
# These directories refer to the forced-call outputs from the original pipeline.
inputBaseDir="/add/results/2025-03-15_original_force_call_dilutions"
outputBaseDir="/add/results/2025-03-15_original_forced_calls_VCF_summary_dilutions"
mergedOutputDir="/add/results/2025-03-15_original_forced_calls_merged_VCF_dilutions"
...
echo "Forced-calling summary processing completed for all original pipeline dilution variants."
