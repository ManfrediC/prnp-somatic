setwd("C:/Users/Manfredi/USZ/Neuropathologie - Carta Manfredi/CJD PRNP/Experiments/SureSelect-sequencing/Analysis/2024-10-13_E200K_read_results")
...
write.csv(e200k, file = "E200K_summary_table.csv", row.names = FALSE)
