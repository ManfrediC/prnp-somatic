...
write_sample_overview_tex <- function(.data, output_path) {
  ...
  lines <- c(
    ...
    "\\toprule[2pt]",
    "\\multirow{2}{*}{Name} & \\multicolumn{4}{c}{Analysed (n)} & \\multicolumn{4}{c}{Max. VAF} & \\multirow{2}{*}{LoB+LoD pass}\\\\",
    "\\cmidrule(lr){2-5}\\cmidrule(lr){6-9}",
    "& Samples & D178N & E200K & P102L & D178N & E200K & P102L & Overall & \\\\",
    "\\midrule",
    row_lines,
    "\\bottomrule[2pt]",
    "\\end{tabular}%",
    "}",
    "\\caption{\\textbf{Overview of ddPCR single-nucleotide variant analysis.} Purified brain DNA from 31 CJD and 8 control individuals was analysed. Shown are the number of samples passing ddPCR quality control overall and per assay, the maximum estimated variant allele fraction (VAF) per assay and across assays, and whether any row passed both LoB and LoD. For CJD30, which was unexpectedly found to be germline heterozygous for E200K, the E200K value is marked with *. Aggregate E200K maxima exclude the CJD30 germline-positive rows. VAFs are reported as a fraction of total analysed DNA.}",
