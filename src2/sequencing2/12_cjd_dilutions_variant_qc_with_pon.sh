...
# -----------------------
MUTECT2_WITH_PON_OUT_ROOT="${MUTECT2_WITH_PON_OUT_ROOT:-results2/sequencing2/runs/mutect2_cjd_dilutions_with_pon}"
...
WITH_PON_VARIANT_QC_RESULTS_ROOT="${WITH_PON_VARIANT_QC_RESULTS_ROOT:-results2/sequencing2/results/mutect2_cjd_dilutions_with_pon/variant_qc}"
WITH_PON_VARIANT_QC_R_SCRIPT="${WITH_PON_VARIANT_QC_R_SCRIPT:-src2/sequencing2/12_cjd_dilutions_variant_table_qc_with_pon.R}"
