...
# Outputs: results2/sequencing2/runs/mutect2_cjd_dilutions_with_pon/{cjd,dilutions}/{vcf,f1r2}/
# ============================================================
set -euo pipefail
shopt -s nullglob
...
PON_OUTPUT_ROOT="${PON_OUTPUT_ROOT:-results2/sequencing2/results/mutect2_controls_pon/panel_of_normals}"
