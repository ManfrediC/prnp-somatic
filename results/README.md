...
- Sequencing QC metrics workflow:
  ...
  - `results/dna_quality/sample_quality_evidence_table.tsv` (current Makefile path via `make dna_quality`)
  - producing script: `src/dna_quality/build_sample_quality_evidence_table.R`
